...
// User WORKS before getting answers

export type ChallengeType =
  | "predict"    // Guess what happens → reveal truth
  | "explain"    // Write in your words → compare
  | "identify"   // Find what's wrong/right
  | "build"      // Arrange/construct something
  | "diagnose"   // Debug a broken scenario
...
export interface Challenge {
  ...
  type: ChallengeType;
  prompt: string;
  context?: string;           // Optional setup/scenario
  choices?: Choice[];         // For multiple choice
  correctOrder?: string[];    // For build/sequence challenges
  hints: string[];            // Progressive hints
  insight: string;            // The learning revealed after
  modelAnswer?: string;       // For explain challenges - compare against
  misconceptions?: string[];  // Common wrong answers to address
}
...
export interface Lesson {
  ...
  transferQuestion?: Challenge; // Final "apply to new situation" test
}
...
export interface Module {
  ...
  title: string;
  description: string;
  coreConcepts: string[];     // What they should be able to explain after
}
...
export const modules: Module[] = [
  {
    ...
    description: "Why AI image generation exists and how it works",
    coreConcepts: [
  ...
  },
  {
    ...
    description: "How words become something a model can use",
    coreConcepts: [
  ...
  },
  {
    ...
    description: "The architecture that makes it work",
    coreConcepts: [
      "What attention does",
  ...
  },
  {
    id: 5,
    title: "Latent Space",
    description: "Why we compress before generating",
    coreConcepts: [
  ...
  },
  {
    id: 6,
    title: "Distillation",
    description: "How to make it fast",
    coreConcepts: [
  ...
  },
  {
    ...
    description: "The complete mental model",
    coreConcepts: [
...
export const lessons: Record<string, Lesson> = {
  ...
  "1-1": {
    ...
    challenges: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "Save millions of pictures and search for the right one", isCorrect: false },
          { id: "b", text: "Write step-by-step drawing instructions for every object", isCorrect: false },
          { id: "c", text: "Show the computer millions of examples so it learns the patterns itself", isCorrect: true },
          { id: "d", text: "Hire artists to draw pictures when people ask", isCorrect: false },
        ],
        hints: [
  ...
  "1-2": {
    ...
    subtitle: "How computers learn to see patterns",
    challenges: [
      {
        id: "1-2-1",
        type: "predict",
        ...
        choices: [
          { id: "a", text: "It saves all 1 million pictures in its memory", isCorrect: false },
          { id: "b", text: "It figures out patterns: 'fluffy' means certain textures, 'running' means certain poses", isCorrect: true },
          { id: "c", text: "It makes smaller copies of each picture", isCorrect: false },
        ],
        hints: [
  ...
  "1-3": {
    ...
    subtitle: "Cleaning up is easier than creating",
    challenges: [
      {
        id: "1-3-1",
        type: "predict",
        ...
        choices: [
          { id: "a", text: "Job A - drawing from nothing", isCorrect: false },
          { id: "b", text: "Job B - cleaning up the fuzzy picture", isCorrect: true },
          { id: "c", text: "They're both equally hard", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "noise", text: "Complete TV static - just random dots" },
          { id: "vague", text: "Blurry colored blobs - can't tell what it is" },
          { id: "shapes", text: "Can see shapes but details are fuzzy" },
          { id: "almost", text: "Almost clear with just a little grain" },
          { id: "clean", text: "Perfect clear picture" },
        ],
        correctOrder: ["noise", "vague", "shapes", "almost", "clean"],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "Both fuzzy versions AND clean versions of the same pictures", isCorrect: true },
          { id: "b", text: "Just clean pictures (then add fuzz yourself to make examples)", isCorrect: true },
          { id: "c", text: "Only fuzzy pictures", isCorrect: false },
          { id: "d", text: "Written descriptions of what 'fuzzy' and 'clean' mean", isCorrect: false },
        ],
        hints: [
  ...
  "1-4": {
    ...
    lessonNumber: 4,
    title: "The Steps",
    subtitle: "What happens when you type a prompt",
    challenges: [
      {
        id: "1-4-1",
        type: "build",
        ...
        choices: [
          { id: "text", text: "You type: 'a cat on a beach'" },
          { id: "tokens", text: "Computer breaks your words into pieces it knows" },
          { id: "embed", text: "Computer figures out what those words MEAN" },
          { id: "noise", text: "Start with TV static (random dots)" },
          { id: "denoise", text: "Clean up the static step by step, guided by your words" },
          { id: "decode", text: "Turn the result into a picture you can see" },
        ],
        correctOrder: ["text", "tokens", "embed", "noise", "denoise", "decode"],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "First step just labels the word, second step understands it", isCorrect: true },
          { id: "b", text: "It's just to make things slower", isCorrect: false },
          { id: "c", text: "First step is for English, second is for other languages", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "The cleanup step isn't paying attention to the words", isCorrect: true },
          { id: "b", text: "The words aren't being used to guide the cleanup", isCorrect: true },
          { id: "c", text: "There wasn't enough static to start with", isCorrect: false },
          { id: "d", text: "The words were spelled wrong", isCorrect: false },
        ],
        hints: [
  ...
  "1-5": {
    ...
    subtitle: "How to skip steps without ruining the picture",
    challenges: [
      {
        id: "1-5-1",
        type: "predict",
        ...
        choices: [
          { id: "a", text: "Each step can only clean up a little bit at a time", isCorrect: true },
          { id: "b", text: "50 is just a random number someone picked", isCorrect: false },
          { id: "c", text: "More steps keeps the computer busy", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "Way worse - you can't skip that many steps", isCorrect: false },
          { id: "b", text: "About 95% as good - tiny quality loss for huge speed gain", isCorrect: true },
          { id: "c", text: "Exactly the same - steps don't matter", isCorrect: false },
          { id: "d", text: "Actually better somehow", isCorrect: false },
        ],
        hints: [
  ...
  "2-1": {
    ...
    subtitle: "Computers only understand numbers",
    challenges: [
      {
        id: "2-1-1",
        type: "predict",
        ...
        choices: [
          { id: "a", text: "The letters c-a-t", isCorrect: false },
          { id: "b", text: "A picture of a cat", isCorrect: false },
          { id: "c", text: "Numbers that represent 'cat'", isCorrect: true },
          { id: "d", text: "The dictionary definition", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "Yes - same word, same numbers", isCorrect: false },
          { id: "b", text: "No - different meanings need different numbers", isCorrect: true },
  ...
  "2-2": {
    ...
    moduleId: 2,
    lessonNumber: 2,
    title: "Breaking Up Words",
    subtitle: "How computers read your text",
    challenges: [
      {
        id: "2-2-1",
        type: "predict",
        ...
        choices: [
          { id: "a", text: "Keep it as one piece: 'unbelievable'", isCorrect: false },
          { id: "b", text: "Every letter: u-n-b-e-l-i-e-v-a-b-l-e", isCorrect: false },
          { id: "c", text: "Meaningful chunks: 'un' + 'believe' + 'able'", isCorrect: true },
          { id: "d", text: "Random chunks", isCorrect: false },
        ],
        hints: [
  ...
  "2-3": {
    ...
    lessonNumber: 3,
    title: "Smart Numbers",
    subtitle: "Numbers that understand meaning",
    challenges: [
      {
        id: "2-3-1",
        type: "predict",
        ...
        choices: [
          { id: "a", text: "'king' and 'queen' (both royalty)", isCorrect: true },
          { id: "b", text: "'king' and 'kingdom' (share letters)", isCorrect: false },
          { id: "c", text: "'king' and 'ring' (rhyme)", isCorrect: false },
          { id: "d", text: "'king' and 'kong' (similar spelling)", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "Random garbage - math doesn't work on words", isCorrect: false },
          { id: "b", text: "Something close to 'queen'", isCorrect: true },
          { id: "c", text: "Something close to 'princess'", isCorrect: false },
          { id: "d", text: "Something close to 'kingdom'", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "Similar meanings get similar numbers", isCorrect: false },
          { id: "b", text: "The computer learns this from reading lots of text", isCorrect: false },
          { id: "c", text: "Words with similar spelling get similar numbers", isCorrect: true },
          { id: "d", text: "Context affects what numbers a word gets", isCorrect: false },
        ],
        hints: [
  ...
  "3-1": {
    ...
    lessonNumber: 1,
    title: "Adding Static",
    subtitle: "How to train by destroying pictures",
    challenges: [
      {
        id: "3-1-1",
        type: "predict",
        ...
        choices: [
          { id: "a", text: "A slightly fuzzy picture", isCorrect: false },
          { id: "b", text: "Just random dots - picture is gone", isCorrect: true },
          { id: "c", text: "A blurry version of the picture", isCorrect: false },
          { id: "d", text: "A pixelated picture", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "clean", text: "Original perfect picture" },
          { id: "light", text: "Tiny bit of grain, still clear" },
          { id: "medium", text: "Noticeable fuzz, can still tell what it is" },
          { id: "heavy", text: "Lots of static, can barely see shapes" },
          { id: "pure", text: "Just random dots - pure static" },
        ],
        correctOrder: ["clean", "light", "medium", "heavy", "pure"],
        hints: [
  ...
  "3-2": {
    ...
    moduleId: 3,
    lessonNumber: 2,
    title: "Removing Static",
    subtitle: "Cleaning up step by step",
    challenges: [
      {
        id: "3-2-1",
        type: "predict",
        ...
        choices: [
          { id: "a", text: "What the final clean picture looks like", isCorrect: false },
          { id: "b", text: "Just the static/fuzz that was added", isCorrect: true },
          { id: "c", text: "What the next step looks like", isCorrect: false },
          { id: "d", text: "What object is in the picture", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "Not enough cleanup steps", isCorrect: true },
          { id: "b", text: "Too many training pictures", isCorrect: false },
          { id: "c", text: "The static is too random", isCorrect: false },
          { id: "d", text: "The text is too short", isCorrect: false },
        ],
        hints: [
  ...
  "3-3": {
    ...
    moduleId: 3,
    lessonNumber: 3,
    title: "Following Your Instructions",
    subtitle: "How the computer listens to what you type",
    challenges: [
      {
        id: "3-3-1",
        type: "predict",
        ...
        choices: [
          { id: "a", text: "Only at the very beginning", isCorrect: false },
          { id: "b", text: "At every single step of cleaning up the fuzzy picture", isCorrect: true },
          { id: "c", text: "Only at the very end", isCorrect: false },
          { id: "d", text: "It doesn't - it just picks a random car picture", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "How fast the picture generates", isCorrect: false },
          { id: "b", text: "How strictly the computer follows your words", isCorrect: true },
          { id: "c", text: "How big the picture is", isCorrect: false },
          { id: "d", text: "How many colors to use", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "More random and creative", isCorrect: false },
          { id: "b", text: "Matches your words better but looks overdone/fake", isCorrect: true },
          { id: "c", text: "Generates faster", isCorrect: false },
          { id: "d", text: "Picture becomes blurry", isCorrect: false },
        ],
        hints: [
  ...
  "4-1": {
    ...
    subtitle: "How computers focus on what matters",
    challenges: [
      {
        id: "4-1-1",
        type: "predict",
        ...
        choices: [
          { id: "a", text: "The mat (because it's the closest word)", isCorrect: false },
          { id: "b", text: "The cat (because cats get tired, mats don't)", isCorrect: true },
          { id: "c", text: "Both equally", isCorrect: false },
          { id: "d", text: "The word 'sat'", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          ...
          { id: "c", text: "Everything equally", isCorrect: false },
  ...
  "4-2": {
    ...
    moduleId: 4,
    lessonNumber: 2,
    title: "Connecting Words to Pictures",
    subtitle: "How your description controls the image",
    challenges: [
      {
        id: "4-2-1",
        type: "predict",
        ...
        choices: [
          { id: "a", text: "Random guess", isCorrect: false },
          { id: "b", text: "It looks at your text to see what you said should be red", isCorrect: true },
          { id: "c", text: "Red is always in the same spot", isCorrect: false },
          { id: "d", text: "It copies from another picture", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "The computer doesn't know colors", isCorrect: false },
          { id: "b", text: "The computer mixed up which color goes with which animal", isCorrect: true },
          { id: "c", text: "There weren't enough steps", isCorrect: false },
          { id: "d", text: "The picture is too small", isCorrect: false },
        ],
        hints: [
  ...
  // MODULE 5: Latent Space
  "5-1": {
    id: "5-1",
    moduleId: 5,
    lessonNumber: 1,
    title: "Working on a Smaller Version",
    subtitle: "Why shrink the picture first?",
    challenges: [
      {
        id: "5-1-1",
        type: "predict",
        ...
        choices: [
          { id: "a", text: "Smaller means the computer works 2x faster", isCorrect: false },
          { id: "b", text: "Smaller means the computer works a bit faster", isCorrect: false },
          { id: "c", text: "Smaller means the computer works MUCH faster (like 50x!)", isCorrect: true },
          { id: "d", text: "Size doesn't affect speed", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "Not enough cleanup steps", isCorrect: false },
          { id: "b", text: "The expand-back-to-full-size step can't add tiny details perfectly", isCorrect: true },
          { id: "c", text: "The description was too short", isCorrect: false },
          { id: "d", text: "Wrong file format", isCorrect: false },
        ],
        hints: [
  ...
  "5-2": {
    ...
    moduleId: 5,
    lessonNumber: 2,
    title: "Shrink, Clean, Expand",
    subtitle: "The three main steps",
    challenges: [
      {
        id: "5-2-1",
        type: "build",
        ...
        choices: [
          { id: "encode", text: "First: Shrink training pictures to learn from" },
          { id: "noise_latent", text: "Add static to those shrunken pictures" },
          { id: "train", text: "Train the AI to clean up the static" },
          { id: "sample_noise", text: "Later: Start with shrunken random static" },
          { id: "denoise", text: "Clean up the static using your words" },
          { id: "decode", text: "Finally: Expand to full size picture" },
        ],
        correctOrder: ["encode", "noise_latent", "train", "sample_noise", "denoise", "decode"],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "They ARE taught all at once", isCorrect: false },
          { id: "b", text: "Teaching one thing at a time is simpler and works better", isCorrect: true },
          { id: "c", text: "Only the shrinker matters", isCorrect: false },
          { id: "d", text: "It's random which order", isCorrect: false },
        ],
        hints: [
  ...
  "6-1": {
    ...
    subtitle: "How the fast version learns from the slow version",
    challenges: [
      {
        id: "6-1-1",
        type: "predict",
        ...
        choices: [
          { id: "a", text: "The original training pictures", isCorrect: false },
          { id: "b", text: "Each of the slow AI's 50 steps", isCorrect: false },
          { id: "c", text: "Just the slow AI's FINAL picture", isCorrect: true },
          { id: "d", text: "Nothing - it figures it out alone", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "The fast AI is broken", isCorrect: false },
          { id: "b", text: "Fewer steps means less time to add tiny details", isCorrect: true },
          { id: "c", text: "The slow AI was trained wrong", isCorrect: false },
          { id: "d", text: "The pictures are too big", isCorrect: false },
        ],
        hints: [
  ...
  "6-2": {
    ...
    moduleId: 6,
    lessonNumber: 2,
    title: "Step by Step Speedup",
    subtitle: "Getting faster gradually",
    challenges: [
      {
        id: "6-2-1",
        type: "predict",
        ...
        choices: [
          { id: "a", text: "Jump directly: 1000 → 8", isCorrect: false },
          { id: "b", text: "Gradually: 1000 → 500 → 250 → 125 → 64 → 32 → 16 → 8", isCorrect: true },
          { id: "c", text: "Both work equally well", isCorrect: false },
          { id: "d", text: "Neither works", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "Drops by half each time", isCorrect: false },
          { id: "b", text: "Drops a tiny bit each time, adds up slowly", isCorrect: true },
          { id: "c", text: "Stays perfectly the same", isCorrect: false },
          { id: "d", text: "Gets better somehow", isCorrect: false },
        ],
        hints: [
    ...
    challenges: [
      {
        ...
        choices: [
          { id: "text", text: "You type: 'a cat astronaut'" },
          { id: "tokenize", text: "Break words into chunks the AI knows" },
          { id: "embed", text: "Turn those chunks into 'smart numbers'" },
          { id: "noise", text: "Start with random static (small version)" },
          { id: "denoise", text: "Clean up the static in 8 steps, guided by your words" },
          { id: "decode", text: "Expand to full size picture" },
          { id: "display", text: "Show you the final picture!" },
        ],
        correctOrder: ["text", "tokenize", "embed", "noise", "denoise", "decode", "display"],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "Half on understanding words, half on making the picture", isCorrect: false },
          { id: "b", text: "Most of the time (80%) on the 8 cleanup steps", isCorrect: true },
          { id: "c", text: "Most on expanding to full size", isCorrect: false },
          { id: "d", text: "Equal time on each step", isCorrect: false },
        ],
        hints: [
  ...
  "7-2": {
    ...
    subtitle: "AI image makers aren't perfect",
    challenges: [
      {
        id: "7-2-1",
        type: "identify",
        ...
        choices: [
          { id: "a", text: "Writing specific text on signs", isCorrect: false },
          { id: "b", text: "Counting exactly 5 apples", isCorrect: false },
          { id: "c", text: "Making pictures in any art style", isCorrect: true },
          { id: "d", text: "Putting red on the cat and blue on the dog (not mixed up)", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "Speed vs quality", isCorrect: false },
          { id: "b", text: "Follows your words more vs looks more natural", isCorrect: true },
          { id: "c", text: "Bigger picture vs smaller picture", isCorrect: false },
          { id: "d", text: "More colors vs less colors", isCorrect: false },
        ],
        hints: [
  ...
  "8-1": {
    ...
    challenges: [
      ...
      },
      {
        ...
        choices: [
          { id: "concepts", text: "Understanding how AI image makers work" },
          { id: "python", text: "Python programming" },
          { id: "pytorch", text: "PyTorch (AI programming tool)" },
          { id: "training", text: "Training AI models" },
          { id: "gpu", text: "Working with powerful graphics cards" },
        ],
        correctOrder: ["concepts", "python", "pytorch", "training", "gpu"],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "A weekend", isCorrect: false },
          { id: "b", text: "A few weeks", isCorrect: false },
          { id: "c", text: "A few months of learning", isCorrect: true },
          { id: "d", text: "Many years of study", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "A lot - you need calculus and linear algebra", isCorrect: false },
          { id: "b", text: "Very little - mostly just understanding what settings do", isCorrect: true },
          { id: "c", text: "None at all - computers do everything", isCorrect: false },
          { id: "d", text: "You need a PhD in mathematics", isCorrect: false },
        ],
        hints: [
    ...
    challenges: [
      {
        ...
        choices: [
          { id: "readme", text: "README: how to actually run it" },
          { id: "config", text: "Settings files: what can you change?" },
          { id: "pipeline", text: "Main flow: how words become pictures" },
          { id: "unet", text: "The cleanup part: how static becomes pictures" },
          { id: "attention", text: "Attention: how words connect to pictures" },
        ],
        correctOrder: ["readme", "config", "pipeline", "unet", "attention"],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "In the shrinking part", isCorrect: false },
          { id: "b", text: "In the word-breaking part", isCorrect: false },
          { id: "c", text: "In the main picture-making part", isCorrect: true },
          { id: "d", text: "In the attention part", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "The AI was specifically trained for 8 steps", isCorrect: true },
          { id: "b", text: "4 is an unlucky number", isCorrect: false },
          { id: "c", text: "Your computer ran out of power", isCorrect: false },
          { id: "d", text: "The words broke", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "When the AI runs during the day", isCorrect: false },
          { id: "b", text: "How much static there is at each cleanup step", isCorrect: true },
          { id: "c", text: "How many pictures to make at once", isCorrect: false },
          { id: "d", text: "The order of words in your prompt", isCorrect: false },
        ],
        hints: [
    ...
    challenges: [
      {
        ...
        choices: [
          { id: "a", text: "Redesign the whole thing", isCorrect: false },
          { id: "b", text: "Fix typos, improve explanations, add examples", isCorrect: true },
          { id: "c", text: "Invent new techniques", isCorrect: false },
          { id: "d", text: "Rewrite all the code", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "docs", text: "Fixing explanations and typos" },
          { id: "bugs", text: "Reporting problems you find" },
          { id: "finetune", text: "Training on new pictures" },
          { id: "params", text: "Testing different settings" },
          { id: "arch", text: "Changing how the AI works inside" },
        ],
        correctOrder: ["docs", "bugs", "finetune", "params", "arch"],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "Great at YOUR cat, worse at other stuff", isCorrect: true },
          { id: "b", text: "Great at all cats", isCorrect: false },
          { id: "c", text: "Better at everything", isCorrect: false },
          { id: "d", text: "Nothing changes, 1000 is too few", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "Just say 'it's broken' and wait", isCorrect: false },
          { id: "b", text: "Write exactly how to trigger the bug: 'Do X, expect Y, get Z instead'", isCorrect: true },
          { id: "c", text: "Guess at a fix even if you might be wrong", isCorrect: false },
          { id: "d", text: "Don't report it - only experts should report bugs", isCorrect: false },
        ],
        hints: [
    ...
    challenges: [
      {
        ...
        choices: [
          { id: "pytorch", text: "PyTorch tutorials (learn the AI tool)" },
          { id: "andrej", text: "Andrej Karpathy's videos (great explainer!)" },
          { id: "hugging", text: "HuggingFace Diffusers (easy AI image library)" },
          { id: "papers", text: "Research papers (the hard stuff)" },
          { id: "code", text: "Read the actual Z-Image code" },
        ],
        correctOrder: ["pytorch", "andrej", "hugging", "code", "papers"],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "Easy tools first - get results, then learn deeper", isCorrect: true },
          { id: "b", text: "Learn everything from scratch first", isCorrect: false },
          { id: "c", text: "Only use easy tools, never go deeper", isCorrect: false },
          { id: "d", text: "Try to learn everything at once", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "Read every file from start to finish", isCorrect: false },
          { id: "b", text: "Run it and see what happens, add test messages", isCorrect: true },
          { id: "c", text: "Memorize diagrams", isCorrect: false },
          { id: "d", text: "Only read the math parts", isCorrect: false },
        ],
        hints: [
          "Reading vs doing",
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "Invent new AI techniques that beat the experts", isCorrect: false },
          { id: "b", text: "Run experiments, understand code, help improve docs, report bugs", isCorrect: true },
          { id: "c", text: "Nothing useful - a few months isn't enough", isCorrect: false },
          { id: "d", text: "Lead a team of AI researchers", isCorrect: false },
        ],
        hints: [
      ...
      },
      {
        ...
        choices: [
          { id: "a", text: "They'll become an expert before starting", isCorrect: false },
          { id: "b", text: "They'll never start - there's always more to learn first", isCorrect: true },
          { id: "c", text: "They'll learn faster than everyone else", isCorrect: false },
          { id: "d", text: "This is the best approach", isCorrect: false },
        ],
        hints: [
...
// Helper to get lessons for a module
